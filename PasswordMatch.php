...
include('connection.php');
   ...
   if(isset($_POST['login']))
    ...
    $re_pass = $_POST['re_enter'];
		$s_query="SELECT * FROM otp";
		$run__=mysqli_query($conn,$s_query);
		while($row=mysqli_fetch_array($run__))
		{
			$rowu=$row['Email'];
		...
		$query="UPDATE otp SET password='$pass' WHERE Email='$name'";
...
<body>
  ...
  <div id="formContent">
    ...
    <input type="text" id="email" class="fadeIn third" name="email" placeholder="Email" required>
	  ...
	  <input type="password" id="password" class="fadeIn third" name="re_enter" placeholder=" Re-enter password" required>

      <input type="submit" name="login" class="fadeIn fourth" value="Confirm">

    </form>

    <!-- Remind Passowrd -->
    <div id="formFooter">
	<a href ="AdminAuthenticate.php">  BACK </a>
