  ...
  <nav class="navbar d-flex navbar-dark bg-dark fixed-top">
 ...
 <!-- <h4 class="text-light"><i class="bi bi-emoji-smile-fi ll text-warning pe-3"></i>Hey Welcome To Galaxy Electronics !<i class="bi bi-emoji-smile-fill text-warning ps-2"></i></h4> -->
